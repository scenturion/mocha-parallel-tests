...
# echo $?
echo 'TESTCASE: cli targets (mocha@3)'
test test/cli-target/index.sh "mocha@3"
echo $?
echo 'TESTCASE: cli targets (mocha@4)'
test test/cli-target/index.sh "mocha@4"
echo $?
echo 'TESTCASE: cli targets (mocha@5)'
test test/cli-target/index.sh "mocha@5"
echo $?
